...
class getPrestashop_Core_Grid_Query_Builder_TitleService extends AdminKernelProdContainer
{
    ...
    {
        return $container->services['prestashop.core.grid.query.builder.title'] = new \PrestaShop\PrestaShop\Core\Grid\Query\TitleQueryBuilder(($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'prod_', ($container->services['PrestaShop\\PrestaShop\\Core\\Grid\\Query\\DoctrineSearchCriteriaApplicatorInterface'] ??= new \PrestaShop\PrestaShop\Core\Grid\Query\DoctrineSearchCriteriaApplicator()), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getContext()->language->id);
    }
}
