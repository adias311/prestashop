...
class getPrestashop_Core_Grid_QueryBuilder_Security_Session_CustomerService extends AdminKernelProdContainer
{
    ...
    {
        return $container->services['prestashop.core.grid.query_builder.security.session.customer'] = new \PrestaShop\PrestaShop\Core\Grid\Query\Security\Session\CustomerQueryBuilder(($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'prod_', ($container->services['PrestaShop\\PrestaShop\\Core\\Grid\\Query\\DoctrineSearchCriteriaApplicatorInterface'] ??= new \PrestaShop\PrestaShop\Core\Grid\Query\DoctrineSearchCriteriaApplicator()), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getContext()->language->id);
    }
}
