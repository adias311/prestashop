...
class getErrorControllerService extends AdminKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.WTld3En'] ?? $container->load('get_ServiceLocator_WTld3EnService'))->withContext('PrestaShopBundle\\Controller\\Admin\\ErrorController', $container));
