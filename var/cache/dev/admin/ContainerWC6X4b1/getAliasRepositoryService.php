...
class getAliasRepositoryService extends AdminKernelDevDebugContainer
{
    ...
    {
        return $container->privates['PrestaShop\\PrestaShop\\Adapter\\Alias\\Repository\\AliasRepository'] = new \PrestaShop\PrestaShop\Adapter\Alias\Repository\AliasRepository(($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'prod_', new \PrestaShop\PrestaShop\Adapter\Alias\Validate\AliasValidator());
    }
}
